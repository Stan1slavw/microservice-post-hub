...
public class PostSearchCriteria implements Specification<Post> {
    ...
    @Override
    public Predicate toPredicate(@NotNull Root<Post> root, CriteriaQuery<?> query, @NotNull CriteriaBuilder criteriaBuilder) {
        ...
        if (Objects.nonNull(request.getContent())){
            predicates.add(criteriaBuilder.like(root.get(Post.TITLE_NAME_FIELD), "%" + request.getContent() + "%" ));
        }
