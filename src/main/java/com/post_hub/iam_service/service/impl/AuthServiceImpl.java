...
public class AuthServiceImpl implements AuthService {
    ...
    public IamResponse<UserProfileDto> login(@NotNull LoginRequest request) {
        ...
        User user = userRepository.findByEmailAndDeletedFalse(request.getEmail()).orElseThrow(()-> new NotFoundException(ApiErrorMessage.INVALID_USER_OR_PASSWORD.getMessage()));
