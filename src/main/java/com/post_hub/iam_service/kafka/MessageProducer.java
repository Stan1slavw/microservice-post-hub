...
public class MessageProducer {
    ...
    private String logsOutputTopic;
    ...
    public void sendLogs(@NotNull @Valid UtilMessage message){
        ...
        try {
            ...
            kafkaTemplate.send(logsOutputTopic, messageJson).get();
            log.debug("Kafka {} message sent. Topic: '{}', message: '{}'", message.getActionType(), logsOutputTopic, messageJson);
