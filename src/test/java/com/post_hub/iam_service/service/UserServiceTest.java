...
public class UserServiceTest {
    ...
    void getById_UserExists_ReturnsUserDTO() {
        when(userRepository.findByIdAndDeletedFalse(1)).thenReturn(java.util.Optional.of(testUser));
    ...
    @Test
    void getById_UserNotFound_TrowsException(){
    ...
    @Test
    void createUser_AsSuperAdmin_CreateUserSuccessfully() {
        NewUserRequest request = new NewUserRequest("NewUser", "password123!", "newuserr@gmail.com");
        ...
        when(userMapper.create(request)).thenReturn(newUser);
